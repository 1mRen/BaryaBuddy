...
public final class TransactionDao_Impl implements TransactionDao {
  ...
  public TransactionDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTransaction = new EntityInsertionAdapter<Transaction>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `transactions` (`id`,`amountCentavos`,`categoryId`,`description`,`date`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(2, entity.getAmountCentavos());
    ...
    this.__updateAdapterOfTransaction = new EntityDeletionOrUpdateAdapter<Transaction>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `transactions` SET `id` = ?,`amountCentavos` = ?,`categoryId` = ?,`description` = ?,`date` = ?,`createdAt` = ? WHERE `id` = ?";
      }
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"transactions"}, new Callable<List<Transaction>>() {
      ...
      public List<Transaction> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfAmountCentavos = CursorUtil.getColumnIndexOrThrow(_cursor, "amountCentavos");
          ...
          while (_cursor.moveToNext()) {
            ...
            final long _tmpAmountCentavos;
            _tmpAmountCentavos = _cursor.getLong(_cursorIndexOfAmountCentavos);
            ...
            _item = new Transaction(_tmpId,_tmpAmountCentavos,_tmpCategoryId,_tmpDescription,_tmpDate,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<Transaction>> getByMonth(final long startOfMonth, final long startOfNextMonth) {
    ...
    _argIndex = 2;
    _statement.bindLong(_argIndex, startOfNextMonth);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"transactions"}, new Callable<List<Transaction>>() {
      @Override
      @NonNull
      public List<Transaction> call() throws Exception {
  ...
  @Override
  public Object getTotalByMonth(final long startOfMonth, final long startOfNextMonth,
      final Continuation<? super Long> $completion) {
    final String _sql = "SELECT SUM(amountCentavos) FROM transactions WHERE date >= ? AND date < ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, startOfMonth);
    _argIndex = 2;
  ...
  public Flow<List<Transaction>> getRecent(final int limit) {
    final String _sql = "SELECT * FROM transactions ORDER BY date DESC, createdAt DESC LIMIT ?";
      ...
      public Transaction call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _result = new Transaction(_tmpId,_tmpAmountCentavos,_tmpCategoryId,_tmpDescription,_tmpDate,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
