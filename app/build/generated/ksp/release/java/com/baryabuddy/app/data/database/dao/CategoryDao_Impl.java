...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategory = new EntityInsertionAdapter<Category>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`name`,`icon`,`color`) VALUES (nullif(?, 0),?,?,?)";
      }
      ...
      public List<Category> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Category(_tmpId,_tmpName,_tmpIcon,_tmpColor);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getById(final long id, final Continuation<? super Category> $completion) {
      ...
      public Category call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final int _tmpColor;
            _tmpColor = _cursor.getInt(_cursorIndexOfColor);
            _result = new Category(_tmpId,_tmpName,_tmpIcon,_tmpColor);
          } else {
            _result = null;
          }
          return _result;
