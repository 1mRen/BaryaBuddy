  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(3) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `user_profile` (`id` INTEGER NOT NULL, `monthlyIncome` REAL NOT NULL, `fixedBills` REAL NOT NULL, `savingsGoal` REAL NOT NULL, `currency` TEXT NOT NULL, `setupCompleted` INTEGER NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '2f7a939782450a366f626fe47f757888')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsUserProfile.put("monthlyIncome", new TableInfo.Column("monthlyIncome", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUserProfile.put("fixedBills", new TableInfo.Column("fixedBills", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsUserProfile.put("savingsGoal", new TableInfo.Column("savingsGoal", "REAL", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "2f7a939782450a366f626fe47f757888", "493b0c15cb2f43d10da4881334635a7c");
